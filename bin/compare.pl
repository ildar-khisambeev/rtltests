...
#   2.11    2015-03-10  warm tube format mode;
# TODO: 
...
GetOptions  (
    ...
    "wtf" => \$wtf,                 # "warm tube" format mode: report all mismatches in order of appearance;
);
...
if ( $help )    {
    ...
    print "\t-w, --wtf\t\t- 'warm tube' format mode: report all mismatches in order of appearance\n";
...
if (@mis) {
    ...
    print "Comparison finished. $tot instructions compared\n";                  # total number of instructions compared;
    unless ($res == 1)  {
        $res = 0;
